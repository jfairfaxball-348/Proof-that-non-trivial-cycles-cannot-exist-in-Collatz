...
BOOT=32_546_278_589; CAP=BOOT-1
...
def St(K0,h,s):
 K=K0+h;S=45*h+s;return Fraction(K)+C*(Fraction(K,2)-Fraction(65,64)*S-Fraction(107,64))
def gain(K0,s):
...
assert (K60,s60)==(6_112_357_564,3) and h60==59_232_591 and g60==59_232_591
assert R60<BOOT and R60.numerator//R60.denominator==32_546_278_582
assert maxrhs[1]==60 and maxrhs[0]==R60
...
assert R2895<BOOT and R2895.numerator//R2895.denominator==CAP and hu==59_224_468
Q=1<<256
...
print('RL336_Q32_CONSUMER_GREEN')
