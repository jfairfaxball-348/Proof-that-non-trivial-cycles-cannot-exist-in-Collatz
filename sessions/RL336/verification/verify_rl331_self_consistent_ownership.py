#!/usr/bin/env python3
"""RL331 dependency: reconstruct total-44 ownership at the lower bootstrap."""
...
H=32_551_214_209; CAP=H-1; OWNED_TOTAL=44
...
# The inherited arbitrary-support consumer alone does not close this lower
# bootstrap; RL331's phase-pairing consumer is checked separately.
assert rhs>H
...
print("RL331_SELF_CONSISTENT_OWNERSHIP_GREEN")
print("candidate_cap",CAP)
