...
BASE = ROOT / 'inherited_rl49_to_rl50' / 'baseline_rl48' / 'rl48_continued' / 'verify_rl48_four_swap_factorization.py'
spec = spec_from_file_location('base', BASE)
...
print('RL49 portable half-rotation radius audit verifier: PASS')
