# RL281 connector-worker lossless transport

RL281 is closed by a connector worker using direct Git-object transport rather than a ZIP archive.

The complete frozen handover is the committed `sessions/RL281/` tree itself. Losslessness/integrity is established by:

- Git blob/tree identities in the atomic RL281 transition commit;
