...
for n in range(1,NMAX+1):
    ...
    if not cur:break
bad=[h for h in hits if h[0]<h[2]+3]; eq=[h for h in hits if h[0]==h[2]+3]
print('PAIR',(A,ELL,Q),'total',total,'peak',peak,'hits',hits,'violations',bad,'equalities',eq,'secs',time.time()-start_time)
