...
for gaps,q in templates(PAIR,P):
    tc+=1
    for x,st in candidates(gaps):rows.append(x)
assert tc==684 and len(rows)==10 and len(set(rows))==10 and max(escape(x) for x in set(rows))==29
gap=32_537_248_343-20_390_252_058;LAM=1+Fraction(1,1<<40)
assert gap==12_146_996_285 and 12*LAM*gap>145_000_000_000 and 12*LAM*gap>23*6_251_274_783
print('RL340_FAST_GREEN')
